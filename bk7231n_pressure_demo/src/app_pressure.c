 ...
 * @LastEditTime: 2021-03-22 17:48:54
 */
...
OPERATE_RET app_pressure_init(IN APP_MODE mode)
{
...
VOID app_report_all_dp_status(VOID)
{
    ...
    dp_arr[0].dpid = DPID_PRESSURE_VALUE;
    dp_arr[0].type = PROP_VALUE;
    dp_arr[0].time_stamp = 0;
    dp_arr[0].value.dp_value = app_ctrl_data.pressure_value;
